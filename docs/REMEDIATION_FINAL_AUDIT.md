...
| Proper i18n migration | Incomplete | `id.json`/`en.json` and keyed translator now cover Auth, admin MFA, and the public Landing page; the legacy DOM walker and dictionary are isolated behind `I18nRuntime`, but workspace/admin component migration and pluralization remain. |
