...
| Client modularization | Incomplete | Domain providers, utilities, leaves, and page boundaries exist; Admin orchestration and ChatSurface are extracted/lazy, but `main.jsx` is still 1,304 lines and legacy Workspace orchestration plus the JSX size gate remain. |
