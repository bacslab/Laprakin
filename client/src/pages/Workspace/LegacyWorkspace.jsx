...
import {
  Archive, ArrowLeft, Bell, CheckCircle2, CircleAlert, CreditCard, FileText, FolderKanban, FolderOpen, HelpCircle,
  LayoutTemplate, LoaderCircle, Mail, Menu, MessageCircle, Moon, PanelLeftClose, PanelLeftOpen,
  PanelRightClose, PanelRightOpen, Plus, Save, Search, Settings2, ShieldCheck, SlidersHorizontal,
  Sparkles, Sun, Trash2, X, ChevronRight, Database, GripVertical, Keyboard, MoreHorizontal, Pin, PinOff,
  BellRing, Shield, Sliders, Monitor, Palette, Languages, CircleUserRound, LogOut as LogOutIcon,
  LayoutDashboard, Users, AlertTriangle, ClipboardList, Megaphone, RefreshCw, MessageSquareText, Activity, FileCog,
} from 'lucide-react';
...
import { ChatSessionRow, SessionGroup } from './Sidebar/ChatSessionRow';
